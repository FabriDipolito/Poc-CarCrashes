...
export default function LoadingTruck({
  ...
  return (
    <motion.div className={cn(
        embedded
          ? 'flex justify-center mt-4 scale-[0.7]'
          : 'fixed inset-0 bg-[rgba(0,0,0,0.4)] z-50 flex items-center justify-center',
        ...
        >
          <div className="flex items-end">
            <div className="flex flex-col items-end w-[92px] h-[45px]">
              <div className="flex-1 w-[92px] h-[14px] bg-[#1590EF] border-t-[3px] border-l-[3px] border-b-[3px] border-black rounded-bl-[4px]" />
              <div className="relative w-[88px] h-[30px] bg-[#1590EF] rounded-bl-[6px] border-l-[3px] border-b-[3px] border-black">
